...
class UnitModel(object):
    def __init__(self):
        # self.client_id 为官网获取的AK， self.client_secret 为官网获取的SK
    ...
    def unit_chat(self,chat_input, user_id="88888"):
        ...
        # 根据 self.client_id 与 self.client_secret 获取 token 的 url https://aip.baidubce.com/oauth/2.0/token?grant_type=client_credentials&self.client_id=%s&self.client_secret=%s
...
if __name__ == '__main__':
    ...
    print(unit_model.unit_chat("你好吗"))